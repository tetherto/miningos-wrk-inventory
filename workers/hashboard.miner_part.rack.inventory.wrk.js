...
class WrkHashboardMinerPartRack extends WrkMinerPartRack {
  getThingType () {
    return super.getThingType() + `-${MINER_PART_TYPES.HASHBOARD.name}`
  }
...
module.exports = WrkHashboardMinerPartRack
